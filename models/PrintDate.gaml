...
global {
		...
		init {
			...
			switch (starting_date.day_of_week) {
			    match 1 { write "Monday"; }
			    match 2 { write "Tuesday"; }
			    match 3 { write "Wednesday"; }
			    match 4 { write "Thursday"; }
			    match 5 { write "Friday"; }
			    match 6 { write "Saturday"; }
			    match 7 { write "Sunday"; }
			}
